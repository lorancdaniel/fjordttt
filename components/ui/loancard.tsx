...
const LoanCard: React.FC<LoanCardProps> = ({ productId, className }) => {
  ...
  return (
    <div
      className={`bg-gray-50 rounded-xl shadow-lg relative ${className || ""}`}
    >
      {product.ranking !== undefined && (
      ...
      <div className="p-4 flex flex-col sm:flex-row items-start sm:items-center">
        ...
        <div className="flex-shrink-0 w-full sm:w-auto sm:ml-6 text-center bg-gray-700 p-4 rounded-lg">
          <div className="mb-2">
      ...
      >
        <div
          ref={contentRef}
          className="p-4 bg-gray-200 border-t border-gray-300"
        >
